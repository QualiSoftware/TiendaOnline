...
<html>
    ...
    <body>
        <div id="todo">
                ...
                <div id="iniciar_Sesion">
                    <s:if test="usi==''">
                        ...
                        <s:form id="frmLogin" action="TiendaLogin" theme="simple">
                            <input type="hidden" name="actionName" value="otros.action"/>
            ...
            Se ha producido un error técnico. Por favor vuelva a intentarlo. De continuar el error por favor póngase 
            en contacto con nosotros para que podamos solucionar el mismo. Muchas gracias y disculpe las molestias.
