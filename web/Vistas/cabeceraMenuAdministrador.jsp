<nav>
        <form name="frm2" action="#" method="post">
            ...
            <!--<a href="/TiendaOnline/Vistas/ColorFiltro.action" class="cambioFondo">Colores</a>-->
            <a href="/TiendaOnline/Vistas/LookFiltro.action" class="cambioFondo">Looks</a>
            <a href="/TiendaOnline/Vistas/MarcasFiltro.action" class="cambioFondo">Marcas</a>
            <a href="/TiendaOnline/Vistas/SubcategoriasFiltro.action" class="cambioFondo">Subcategorías</a>
